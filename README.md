...
##Запуск
* Если у вас windows, в папке exe_for_windows лежит уже собранный exe файл. Для запуска необходимо иметь пакет [MVC++](https://www.microsoft.com/ru-ru/download/details.aspx?id=5555)
* Если у вас другая ОС, вам необходимо скачать python версии 3 и запустить файл main.py
